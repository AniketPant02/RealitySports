...
# OPEN SOURCE CODE PREPARED BY NVIDIA FOR PROCESSING RECORD3D LIDAR FIELDS TO NERF INPUTS.
# THIS SCRIPT CALCULATES ROTATIONAL TRANSFORMATIONS FOR LIDAR RECORDINGS.
